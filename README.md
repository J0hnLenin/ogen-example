...
Спецификация OpenAPI описывает CRUD-операции над сущностью **Игрок (Player)**.
...
> **TODO**: добавить скриншот PR с описанием изменений.

Ключевые доработки включают:
- Поддержку специфичных настроек генерации через конфигурационные файлы.
- Улучшенную обработку ошибок и кастомизацию HTTP‑ответов.
- Гибкую настройку путей для клиента и сервера.
